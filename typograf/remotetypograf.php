...
'.
  $SOAPBody;
    ...
    $typografResponse = str_replace ('&lt;', '<', $typografResponse);
    $typografResponse = str_replace ('&gt;', '>', $typografResponse);
    $typografResponse = str_replace ('<br />', "", $typografResponse);
    
    $typografResponse = str_replace ('<nobr>', "<span style='white-space:nowrap'>", $typografResponse);
    $typografResponse = str_replace ('<nobr class="phone">', "<span style='white-space:nowrap' class='phone'>", $typografResponse);
    
    $typografResponse = str_replace ('</nobr>', "</span>", $typografResponse);
